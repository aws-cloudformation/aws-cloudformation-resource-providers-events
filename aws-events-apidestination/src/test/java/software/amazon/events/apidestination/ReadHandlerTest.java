...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        DescribeApiDestinationResponse archiveName = DescribeApiDestinationResponse.builder()
                .name(API_DESTINATION_NAME)
                .apiDestinationState(API_DESTINATION_STATE)
                .apiDestinationArn(API_DESTINATION_ARN)
                .build();
        doReturn(archiveName)
                .when(proxy)
    ...
    @Test
    public void handleRequest_DestinationNotExistFailure() {
        final ResourceModel model = ResourceModel.builder()
                .name(API_DESTINATION_NAME)
                .build();
