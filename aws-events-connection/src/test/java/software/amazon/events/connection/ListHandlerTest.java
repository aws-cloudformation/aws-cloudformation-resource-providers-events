...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ListConnectionsResponse listResponse = ListConnectionsResponse.builder()
        ...
        assertThat(response.getResourceModels().get(0).getName()).isEqualTo("connection-1");
        assertThat(response.getResourceModels().get(1).getName()).isEqualTo("connection-2");
