...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void setup() {
        ...
        handler = new ListHandler(eventBridgeClient);
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ListEventBusesResponse listEventBusesResponse = ListEventBusesResponse.builder()
                .eventBuses(EventBus.builder().name(testEventBusName).build()).build();

        when(eventBridgeClient.listEventBuses(any(ListEventBusesRequest.class)))
                .thenReturn(listEventBusesResponse);
